...
const packetV2PdfRouter = require("./server/routes/packetV2Pdf");
app.use("/api/packet-v2-pdf", packetV2PdfRouter);

// -------- Narrative V2 route --------
const narrativeV2Router = require("./server/routes/narrativeV2");
app.use("/api/intelligence", narrativeV2Router);

// -------- Narrative V3 route --------
const narrativeV3Router = require("./server/routes/narrativeV3");
app.use("/api/intelligence", narrativeV3Router);
