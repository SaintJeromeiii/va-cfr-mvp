...
// -------- API routes --------
// Intelligence/scoring routes
const intelligenceRoutes = require("./server/routes/intelligence");
app.use("/api/intelligence", intelligenceRoutes);

// Gap finder routes
const gapsRoutes = require("./server/routes/gaps");
app.use("/api/intelligence", gapsRoutes);

// Packet builder v2 routes
const packetV2Routes = require("./server/routes/packetV2");
app.use("/api/intelligence", packetV2Routes);

// Packet builder v2 PDF routes
const packetV2PdfRoutes = require("./server/routes/packetV2Pdf");
app.use("/api/intelligence", packetV2PdfRoutes);
